...
import com.ilyft.user.Activities.CouponActivity;
import com.ilyft.user.Activities.CustomGooglePlacesSearch;
import com.ilyft.user.Activities.Payment;
import com.ilyft.user.Activities.ShowProfile;
...
//        });
    ...
    private void updateLocationToAdmin(String latitude, String longitude) {
        ...
        try {
            ...
            utils.print("SendRequestUpdate", "" + object.toString());
        } catch (Exception e) {
            e.printStackTrace();
        }
...
//            e.printStackTrace();
//        }
        String constructedURL1 = URLHelper.base + URLHelper.GET_PAYMENT_CONFIRMATION+totalFee+"?req_id="+SharedHelper.getKey(getApplicationContext(),"request_id");
